...
return new class extends Migration
{
    ...
    {
        Schema::create('personnel_retireds', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('personnel_subgrp_name')->nullable();
            ...
            $table->string('ansvh')->nullable();
            $table->string('ansvh_text')->nullable();
    ...
    {
        Schema::dropIfExists('personnel_retireds');
    }
};
