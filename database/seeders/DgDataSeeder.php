        ...
        $dgMappings = [
            ...
            'DG0202' => [
                ...
                [
                    ...
                    'fields' => [
                        'student_id' => 'STUDENTCODE',
                        'title_th' => ['mapping' => 'NAME_THAI', 'formatting' => ['title_th']],
                        'first_name_th' => ['mapping' => 'NAME_THAI', 'formatting' => ['first_name_th']],
                        'last_name_th' => ['mapping' => 'NAME_THAI', 'formatting' => ['last_name_th']],
                        'full_name_th' => 'NAME_THAI',
                        'title_en' => ['mapping' => 'NAME_ENGLISH', 'formatting' => ['title_en']],
                        'first_name_en' => ['mapping' => 'NAME_ENGLISH', 'formatting' => ['first_name_en']],
                        'last_name_en' => ['mapping' => 'NAME_ENGLISH', 'formatting' => ['last_name_en']],
            ...
            'DG0301' => [
                ...
                'fields' => [
                    ...
                    'begin_date' => ['mapping' => 'BEGIN_DATE', 'formatting' => $dateFmt],
                    'end_date' => ['mapping' => 'END_DATE', 'formatting' => $dateFmt],
                    'status_id' => 'STATUS_ID',
            ...
            'DG0303' => [
                [
                    ...
                    'fields' => [
                        ...
                        'gender' => 'GENDER',
                        'birth_date' => ['mapping' => 'BIRTH_DATE', 'formatting' => $dateFmt],
                ...
                [
                    'model' => \App\Models\Resources\Personnel::class,
                    'fields' => [
                        'personnel_id' => 'PERSONNEL_ID',
                        'title_th' => 'TITLE_TH',
            ...
            'DG0305' => [
                ...
                'fields' => [
                    ...
                    'contract_end_date' => ['mapping' => 'CONTRACT_END_DATE', 'formatting' => $dateFmt],
            ...
            'DG0306' => [
                ...
                'fields' => [
                    ...
                    'graduate_date' => ['mapping' => 'GRADUATE_DATE', 'formatting' => $dateFmt],
                ],
            ...
            'DG0314' => [
                ...
                [
                    ...
                    'fields' => [
                        ...
                        'citizen_id' => 'CITIZEN_ID',
                        'passport_no' => 'PASSPORT_NUMBER',
                        'personnel_status' => 'STATUS_ID',
                        'personnel_type' => 'STAFF_GROUP',
                        'personnel_group' => 'PERSONNEL_GRP_NAME',
                        'personnel_subgroup' => 'PERSONNEL_SUBGRP_NAME',
                        'position_name' => 'POSITION_NAME',
                        'position_number' => 'POSITION_NUMBER',
                        ...
                        'structure_level3_name' => 'STRUCTURE_LEVEL3_NAME',
                        'structure_level4_name' => 'STRUCTURE_LEVEL4_NAME',
                        'start_date' => ['mapping' => 'BEGIN_DATE', 'formatting' => $dateFmt],
                    ],
                ],
            ],
            'DG0315' => [
        ...
        DB::transaction(function () use ($dgMappings) {
            foreach ($dgMappings as $dgCode => $configs) {
                ...
                foreach ($configList as $config) {
                    ...
                    foreach ($config['fields'] as $fillableField => $fieldConfig) {
                        $csvHeader = is_array($fieldConfig) ? $fieldConfig['mapping'] : $fieldConfig;
                        $formatting = is_array($fieldConfig) ? ($fieldConfig['formatting'] ?? []) : [];
                        ...
                        TransformerMapping::updateOrCreate(
                            ...
                            [
                                'mapping' => $csvHeader,
                                'formatting' => json_encode($formatting),
