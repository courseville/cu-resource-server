...
Route::prefix('v1')->middleware('clients')->group(function () {
    ...
    Route::get('/academic-programs/{id}', [AcademicProgramController::class, 'show'])->name('academic-programs.show');
    Route::get('/admission-applications', [AdmissionApplicationController::class, 'index'])->name('admission-applications.index');
    Route::get('/admission-applications/{id}', [AdmissionApplicationController::class, 'show'])->name('admission-applications.show');
    Route::get('/contract-personnels', [ContractPersonnelController::class, 'index'])->name('contract-personnels.index');
    Route::get('/contract-personnels/{id}', [ContractPersonnelController::class, 'show'])->name('contract-personnels.show');
    Route::get('/course-instructors', [CourseInstructorController::class, 'index'])->name('course-instructors.index');
    Route::get('/course-instructors/{id}', [CourseInstructorController::class, 'show'])->name('course-instructors.show');
    Route::get('/course-schedules', [CourseScheduleController::class, 'index'])->name('course-schedules.index');
    Route::get('/course-schedules/{id}', [CourseScheduleController::class, 'show'])->name('course-schedules.show');
    ...
    Route::get('/fulltime-personnels/{id}', [FulltimePersonnelController::class, 'show'])->name('fulltime-personnels.show');
    Route::get('/grant-details', [GrantDetailController::class, 'index'])->name('grant-details.index');
    Route::get('/grant-details/{id}', [GrantDetailController::class, 'show'])->name('grant-details.show');
    Route::get('/interview-portfolios', [InterviewPortfolioController::class, 'index'])->name('interview-portfolios.index');
    Route::get('/interview-portfolios/{id}', [InterviewPortfolioController::class, 'show'])->name('interview-portfolios.show');
    Route::get('/interview-quotas', [InterviewQuotaController::class, 'index'])->name('interview-quotas.index');
    Route::get('/interview-quotas/{id}', [InterviewQuotaController::class, 'show'])->name('interview-quotas.show');
    ...
    Route::get('/personnel-salaries/{id}', [PersonnelSalaryController::class, 'show'])->name('personnel-salaries.show');
    ...
    Route::get('/program-committees/{id}', [ProgramCommitteeController::class, 'show'])->name('program-committees.show');
    Route::get('/quota-applications', [QuotaApplicationController::class, 'index'])->name('quota-applications.index');
    Route::get('/quota-applications/{id}', [QuotaApplicationController::class, 'show'])->name('quota-applications.show');
    Route::get('/retired-personnels', [RetiredPersonnelController::class, 'index'])->name('retired-personnels.index');
    Route::get('/retired-personnels/{id}', [RetiredPersonnelController::class, 'show'])->name('retired-personnels.show');
    ...
    Route::get('/scholarship-applications/{id}', [ScholarshipApplicationController::class, 'show'])->name('scholarship-applications.show');
    Route::get('/structure-profiles', [StructureProfileController::class, 'index'])->name('structure-profiles.index');
    Route::get('/structure-profiles/{id}', [StructureProfileController::class, 'show'])->name('structure-profiles.show');
    Route::get('/student-admissions', [StudentAdmissionController::class, 'index'])->name('student-admissions.index');
    Route::get('/student-admissions/{id}', [StudentAdmissionController::class, 'show'])->name('student-admissions.show');
    Route::get('/student-applications', [StudentApplicationController::class, 'index'])->name('student-applications.index');
    Route::get('/student-applications/{id}', [StudentApplicationController::class, 'show'])->name('student-applications.show');
    Route::get('/student-graduations', [StudentGraduationController::class, 'index'])->name('student-graduations.index');
    Route::get('/student-graduations/{id}', [StudentGraduationController::class, 'show'])->name('student-graduations.show');
    Route::get('/student-internships', [StudentInternshipController::class, 'index'])->name('student-internships.index');
    Route::get('/student-internships/{id}', [StudentInternshipController::class, 'show'])->name('student-internships.show');
    Route::get('/student-status-histories', [StudentStatusHistoryController::class, 'index'])->name('student-status-histories.index');
    Route::get('/student-status-histories/{id}', [StudentStatusHistoryController::class, 'show'])->name('student-status-histories.show');
});
