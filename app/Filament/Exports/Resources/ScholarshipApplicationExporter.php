...
class ScholarshipApplicationExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('confirm')->label('Confirmed'),
            ExportColumn::make('money_a')->label('Money A'),
            ExportColumn::make('money_b')->label('Money B'),
            ExportColumn::make('money_b_m')->label('Money B (Monthly)'),
            ExportColumn::make('money_c')->label('Money C'),
            ExportColumn::make('has_house')->label('Has House'),
