...
class InterviewQuotaExporter extends Exporter
{
    ...
    {
        $body = 'Your interview quota export has completed and '.Number::format($export->successful_rows).' '.str('row')->plural($export->successful_rows).' exported.';
