...
class CurriculumExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('no_year_study')->label('Years of Study'),
            ExportColumn::make('plan1'),
            ExportColumn::make('language1'),
            ExportColumn::make('program_system'),
            ExportColumn::make('calendar'),
            ExportColumn::make('begin_year'),
            ExportColumn::make('begin_semester'),
