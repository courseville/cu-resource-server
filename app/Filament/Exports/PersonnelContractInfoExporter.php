...
class PersonnelContractInfoExporter extends Exporter
{
    ...
    {
        $body = 'Your personnel contract info export has completed and '.Number::format($export->successful_rows).' '.str('row')->plural($export->successful_rows).' exported.';
