        ...
        return $table
            ->columns([
                ...
                TextColumn::make('full_name_th')
                    ->label('Full Name (TH)')
                    ->state(fn (Student $record) => $record->full_name_th ?: "{$record->title_th} {$record->first_name_th} {$record->last_name_th}"),
                TextColumn::make('full_name_en')
                    ->label('Full Name (EN)'),
            ])
            ->searchable(['student_id', 'title_th', 'first_name_th', 'last_name_th', 'full_name_th', 'title_en', 'first_name_en', 'last_name_en', 'full_name_en'])
            ->filters([
                //
            ])
            ->headerActions([
