...
class PersonnelContractInfoImporter extends Importer
{
    ...
    public function resolveRecord(): PersonnelContractInfo
    {
        return new PersonnelContractInfo();
    }

    public static function getCompletedNotificationBody(Import $import): string
    {
        $body = 'Your personnel contract info import has completed and ' . Number::format($import->successful_rows) . ' ' . str('row')->plural($import->successful_rows) . ' imported.';
