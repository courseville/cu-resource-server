...
class PersonnelRetiredImporter extends Importer
{
    ...
    public function resolveRecord(): PersonnelRetired
    {
        return new PersonnelRetired();
    }

    public static function getCompletedNotificationBody(Import $import): string
    {
        $body = 'Your personnel retired import has completed and ' . Number::format($import->successful_rows) . ' ' . str('row')->plural($import->successful_rows) . ' imported.';
